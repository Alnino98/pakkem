...
function anggota($mst_nama,$kantor,$mst_jenis_kelamin,$mst_tempat_lahir,$mst_tanggal_lahir,$mst_nik,$email,$mst_hp,$mst_wa,$mst_pendidikan,$mst_sertifikat,$keterangan,$namafoto){
	global $konek;

	$sql="INSERT INTO `mst_anggota`(`mst_nama`, `kantor`, `mst_jenis_kelamin`, `mst_tempat_lahir`, `mst_tanggal_lahir`, `mst_nik`, `email`, `mst_hp`, `mst_wa`, `mst_pendidikan`, `mst_sertifikat`, `keterangan`,`namafoto`) 
		VALUES ('$mst_nama','$kantor','$mst_jenis_kelamin','$mst_tempat_lahir','$mst_tanggal_lahir','$mst_nik','$email','$mst_hp','$mst_wa','$mst_pendidikan','$mst_sertifikat','$keterangan','$namafoto')";
		if (mysqli_query($konek, $sql)) {
		    return true;
		} else {
		    return false;
...
function simpanpendidikan($nama,$id_pendaftar,$statusp,$kota,$kecamatan,$kodepos,$namaslta,$noijazah,$tahunlulus,$status,$foto){
	global $konek;

	$sql="INSERT INTO `pendidikan`(`nama_pendaftar`, `id_pendaftar`, `status_slta`, `kota`, `kecamatan`, `kode_pos`, `nama_slta`, `no_ijazah`, `tahun lulus`,`status`) VALUES('$nama','$id_pendaftar','$statusp','$kota','$kecamatan','$kodepos','$namaslta','$noijazah','$tahunlulus','$status','$mst_foto')";
