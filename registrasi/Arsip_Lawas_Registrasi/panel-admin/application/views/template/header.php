            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="<?= base_url('login') ?>" onclick="return(confirm('Anda Akan Keluar Dari Halaman Administrator'))" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
  ...
  <!-- Left side column. contains the logo and sidebar -->
   <aside class="main-sidebar">
	...
	<?php if($this->session->userdata('level') == "admin"){ ?>
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-cubes"></i> <span>Anggota</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu"> 
      <li><a href="<?= base_url('admin/anggota') ?>"><i class="fa fa-circle-o"></i>Anggota</a></li>
          </ul>
        </li>
	...
	<li class="treeview">
          ...
          <ul class="treeview-menu"> 
            <li><a href="<?= base_url('admin/pegawai') ?>" class="active"><i class="fa fa-circle-o"></i>Anggota</a></li>
          </ul>
        </li>   
