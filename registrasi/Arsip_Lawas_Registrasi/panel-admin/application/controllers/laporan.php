...
class laporan extends CI_controller
{
	...
	public function laporan_anggota($value='')
	{
	 $x = array('judul' =>'Data Anggota',
	             'data'=>$this->m_laporan->anggota(),
	             'print'=>FALSE,);	
	 tpl('laporan/anggota',$x);	
	}
	...
	public function laporan_anggota_print($value='')
	{
	 $x = array('judul' =>'Laporan Data Pegawai Terdaftar',
	             'data'=>$this->m_laporan->anggota(),
	             'print'=>TRUE,);	
	 $this->load->view('laporan/anggota',$x);	
	}
