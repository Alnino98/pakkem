      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="templates/calon_member.php"><i class="fas fa-user-plus"></i>&nbsp;&nbsp;Pendaftar Masuk</a>
            <a class="collapse-item" href="404.html"><i class="far fa-image"></i>&nbsp;&nbsp;Foto Masuk</a>
            <a class="collapse-item" href="404.html"><i class="far fa-file-alt"></i>&nbsp;&nbsp;Sertifikat Masuk</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="404.html"><i class="far fa-paper-plane"></i>&nbsp;&nbsp;Kirim Email</a>
            ...
            <div class="col-xl-8 col-lg-7">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  ...
                  <hr>
                  Info detail member bisa dilihat di <code>tabel-anggota/anggota-terdaftar/anggota-aktif</code> di fitur kelola Admin.
                </div>
              </div>
