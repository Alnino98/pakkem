            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="blank.html"><i class="far fa-image"></i>&nbsp;&nbsp;Foto
                            Masuk</a>
                        <a class="collapse-item" href="blank.html"><i
                                ...
                                <div class="col-xl-8 col-lg-7">
                                    ...
                                    <div class="card shadow mb-4">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <code>tabel-anggota/anggota-terdaftar/anggota-aktif</code> di fitur
                                            kelola Admin.
                                        </div>
                                    </div>
