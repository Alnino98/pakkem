...
(2, 'admin', 'c8381c161aa89d09ab1905bded539435', 'admin', 'admin', '2020-05-23 04:11:59'),
(3, 'user', 'f4063aaaac7ee09398df878716a1b9d1', 'User', 'user', '2020-06-05 05:05:31');
...
--
ALTER TABLE `mst_anggota`
  MODIFY `mst_no_pendaftaran` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=88;
