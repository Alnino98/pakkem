...
--
-- Host: localhost:3306
-- Generation Time: Sep 18, 2020 at 11:03 PM
...
(2, 'admin', '21232f297a57a5a743894a0e4a801fc3', 'admin', 'admin', '2020-05-22 02:25:44'),
(3, 'user', 'f4063aaaac7ee09398df878716a1b9d1', 'User', 'user', '2020-06-05 05:04:35');
...
--
ALTER TABLE `mst_anggota`
  MODIFY `mst_no_pendaftaran` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
