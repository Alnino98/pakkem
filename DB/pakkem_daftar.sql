...
--
-- Host: localhost:3306
-- Generation Time: Sep 23, 2020 at 06:41 PM
...
--
ALTER TABLE `anggota`
  MODIFY `id_pendaftar` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `pendaftar`
  MODIFY `id_pendaftar` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=69;
